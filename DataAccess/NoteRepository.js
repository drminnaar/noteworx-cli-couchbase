...
//                     const key = determineKey(title);

//                     const combinedTags = note
//                         .tags
//                         .concat(tags.split(',').map(tag => tag.trim().toLowerCase()));

//                     note.tags = Array.from(new Set(combinedTags));

//                     bucket.upsert(key, note, (error) => {
//                         bucket.disconnect();
